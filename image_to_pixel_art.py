...
def image_to_pixel(A_path, save_path):
    """Converts image with a given path to pixel art."""
    global transform_A
...
if __name__ == "__main__":
    ...
    Path("pixel-art").mkdir(exist_ok=True)

    # image_list = [f for f in os.listdir("images") if f.rpartition('.')[2] in ('jpg','jpeg','png')]
    for image_name in os.listdir("images"):
        if image_name.split(".")[1] not in ["jpg", "jpeg", "png"]:
            continue
        image_path = "images/" + image_name
        save_path = "pixel-art/pix_" + image_name
        image_to_pixel(image_path, save_path)
        print(image_name)
